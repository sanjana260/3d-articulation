...
model = dict(
    ...
    levels=(0,),
    image_feature_channels=(1536,) * 5,  # dinov2 large
    pred_ln=False,
    backbone=dict(
        type="SpUNet-v1m1-distill",
        in_channels=9,
        num_classes=200,
            ...
            dict(
                ...
                transform=[
                    ...
                    dict(
                        ...
                        hash_type="fnv",
                        mode="train",
                        keys=("coord", "color", "normal", "segment", "image_coord", "image_mask"),
    ...
    test=dict(
        ...
        test_cfg=dict(
            ...
            post_transform=[
                ...
                dict(
                    type="Collect",
                    keys=("coord", "grid_coord", "index", "image", "image_coord", "image_mask"),
                    feat_keys=("coord", "color", "normal"),
                ),
            ],
            aug_transform=[
